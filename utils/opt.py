...
def parse_opt():
    ...
    parser.add_argument('--fusion_activity', type=str, default='ReLU',
                        help='ReLU, Tanh, Sigmoid for unlinear function in fusion model')
    ...
    parser.add_argument('--object_projected_size', type=int, default=1024)  # #####################
    ...
    parser.add_argument('--max_words', type=int, default=22)
