...
class LOCATE(nn.Module):
     ...
     def forward(self, frame_feats, object_feats, phr_feats, last_hidden, phr_masks):
            ...
            semantic_group_feats = torch.cat([semantic_obj_feats, semantic_frame_feats, phr_feats],
                                             dim=2)
...
class RELATE(nn.Module):
    ...
    def forward(self, i3d_feats, object_feats, phr_feats, last_hidden, phr_masks):
        ...
        semantic_group_feats = torch.cat([semantic_obj_feats, semantic_i3d_feats, phr_feats],
                                         dim=2)
...
class ModuleSelection(nn.Module):
    def __init__(self, opt):
        ...
        if opt.use_rel:
            rel_feat_size = opt.word_size + opt.hidden_size * 4
