...
class LOCATE(nn.Module):
     ...
     def forward(self, frame_feats, object_feats, phr_feats, last_hidden, phr_masks):
            ...
            phr_obj_feats = self.cnnembedded(semantic_obj_feats)

            semantic_frame_feats, _, _ = self.semantic_alignment(
                phr_feats=phr_obj_feats,
                vis_feats=frame_feats)



            semantic_group_feats = torch.cat([semantic_frame_feats, phr_obj_feats],
                                             dim=2)
...
class RELATE(nn.Module):
    ...
    def forward(self, i3d_feats, object_feats, phr_feats, last_hidden, phr_masks):
        ...
        semantic_group_feats = torch.cat([semantic_i3d_feats, phr_obj_feats],
                                         dim=2)
