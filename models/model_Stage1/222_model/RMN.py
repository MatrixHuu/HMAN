...
class RELATE(nn.Module):
    def __init__(self, opt):
        ...
        # self.self_attention = SelfAttention(input_size, input_size,
        #                                     input_size, opt.dropout, True)
    ...
    def forward(self, i3d_feats, object_feats, hidden_state):
        ...
        # feat = torch.cat([pairwise_feat, i3d_feats], dim=-1)
...
class Decoder(nn.Module):
    def __init__(self, opt, vocab):
        ...
        self.vit = VisionTransformer(img_size=26,
                                     patch_size=2,
                                     embed_dim=768,
                                     depth=2,
                                     num_heads=12,
    ...
    def decode(self, frame_feats, i3d_feats, object_feats, previous_cells, att_lstm_h, lang_lstm_h, lang_lstm_c):
        ...
        vit = self.vit(object_feats.permute(0, 3, 2, 1))

        # language lstm decoder
        decoder_input = torch.cat([vit, att_lstm_h], dim=1)
