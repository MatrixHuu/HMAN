...
from models.RMN_enhVaConVmAttshare_220120.sim_matrix import *
...
class LOCATE(nn.Module):
    def __init__(self, opt):
        ...
        # self.spatial_attn = SelfAttention(opt.region_projected_size, opt.region_projected_size, opt.region_projected_size, opt.dropout, False) # hidden_size*2, hidden_size*2, hidden_size, args.dropout, False
        self.enhance = EnhancedObj(opt)
        ...
        self.self_attention = SelfAttention(2048, 512, 512)


    def forward(self, frame_feats, object_feats, i3d_feats, hidden_state):
        """
        ...
        object_feats_att = self.enhance(frame_feats, object_feats)
        ...
        out, _ = self.self_attention(feat, hidden_state)
...
class Decoder(nn.Module):
    ...
    def decode(self, frame_feats, i3d_feats, object_feats, previous_cells, att_lstm_h, lang_lstm_h, lang_lstm_c):
        ...
        feats = self.loc(frame_feats, object_feats, i3d_feats, att_lstm_h) if self.use_loc else None
