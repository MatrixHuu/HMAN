...
class Decoder(nn.Module):
    ...
    def decode(self, frame_feats, i3d_feats, object_feats, att_lstm_h, lang_lstm_h, lang_lstm_c, embedded, phr_feats, phr_masks):

        feats = self.reasoning(frame_feats, i3d_feats, object_feats, phr_feats, att_lstm_h, phr_masks)
    ...
    def beam_search(self, batch_size, vocab_size, frame_feats, i3d_feats, object_feats, global_feat, width):
